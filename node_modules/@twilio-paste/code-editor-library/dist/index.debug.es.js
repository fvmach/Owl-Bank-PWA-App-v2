...
function Mt({ children: t }) {
  return mt.createElement("div", { style: Y.container }, t);
}
var Z = Mt;
var $ = Z;
function Et({ width: t, height: r, isEditorReady: n, loading: e, _ref: a, className: m, wrapperProps: E }) {
  return K.createElement("section", { style: { ...v.wrapper, width: t, height: r }, ...E }, !n && K.createElement($, null, e), K.createElement("div", { ref: a, style: { ...v.fullWidth, ...!n && v.hide }, className: m }));
}
var tt = Et;
var H = yt(tt);
function Ct(t) {
...
function Ot({ original: t, modified: r, language: n, originalLanguage: e, modifiedLanguage: a, originalModelPath: m, modifiedModelPath: E, keepCurrentOriginalModel: S = false, keepCurrentModifiedModel: N = false, theme: x = "light", loading: P = "Loading...", options: y = {}, height: V = "100%", width: z = "100%", className: F, wrapperProps: j = {}, beforeMount: A = h, onMount: q = h }) {
  let [M, O] = rt(false), [T, s] = rt(true), u = k(null), c = k(null), w = k(null), d = k(q), o = k(A), D = k(false);
  b(() => {
  ...
  return kt.createElement(H, { width: z, height: V, isEditorReady: M, loading: P, _ref: w, className: F, wrapperProps: j });
}
var it = Ot;
var wt = Tt(it);
function Ht(t) {
...
function Vt({ defaultValue: t, defaultLanguage: r, defaultPath: n, value: e, language: a, path: m, theme: E = "light", line: S, loading: N = "Loading...", options: x = {}, overrideServices: P = {}, saveViewState: y = true, keepCurrentModel: V = false, width: z = "100%", height: F = "100%", className: j, wrapperProps: A = {}, beforeMount: q = h, onMount: M = h, onChange: O, onValidate: T = h }) {
  let [s, u] = ut(false), [c, w] = ut(true), d = C(null), o = C(null), D = C(null), U = C(M), L = C(q), I = C(), i = C(e), f = st(m), Q = C(false), B = C(false);
  b(() => {
  ...
  return Wt.createElement(H, { width: z, height: F, isEditorReady: s, loading: N, _ref: D, className: j, wrapperProps: A });
}
var ft = Vt;
var dt = zt(ft);
...
export {
  dt as CodeEditor,
  wt as CodeEditorDiff,
  PasteTheme as CodeEditorPasteTheme
};
