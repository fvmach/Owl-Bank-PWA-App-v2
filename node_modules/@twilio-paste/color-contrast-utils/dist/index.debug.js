...
function E(r2) {
  return !(!I(r2) || (e2 = r2, v && v in e2)) && (function(r3) {
    ...
    return "[object Function]" == e3 || e3 == t;
  }(r2) || function(r3) {
    var e3 = false;
    if (null != r3 && "function" != typeof r3.toString)
      try {
        e3 = !!(r3 + "");
      } catch (r4) {
      }
...
O.prototype.clear = function() {
  ...
  var e2 = this.__data__;
  return j ? void 0 !== e2[r2] : m.call(e2, r2);
}, O.prototype.set = function(r2, e2) {
  return this.__data__[r2] = j && void 0 === e2 ? "__lodash_hash_undefined__" : e2, this;
...
function S(r2, e2) {
  ...
  return ("string" == (n2 = typeof (t2 = e2)) || "number" == n2 || "symbol" == n2 || "boolean" == n2 ? "__proto__" !== t2 : null === t2) ? a2["string" == typeof e2 ? "string" : "hash"] : a2.map;
}
function $(r2, e2) {
  var t2 = function(r3, e3) {
    return null == r3 ? void 0 : r3[e3];
  }(r2, e2);
  return E(t2) ? t2 : void 0;
}
function I(r2) {
  var e2 = typeof r2;
  return !!r2 && ("object" == e2 || "function" == e2);
}
var L = function(r2) {
...
var C = e(function(r2) {
  var e2 = Array.prototype.concat, t2 = Array.prototype.slice, n2 = r2.exports = function(r3) {
    for (var n3, a2 = [], o2 = 0, i2 = r3.length; o2 < i2; o2++) {
      var l2 = r3[o2];
      (n3 = l2) && "string" != typeof n3 && (n3 instanceof Array || Array.isArray(n3) || n3.length >= 0 && (n3.splice instanceof Function || Object.getOwnPropertyDescriptor(n3, n3.length - 1) && "String" !== n3.constructor.name)) ? a2 = e2.call(a2, t2.call(l2)) : a2.push(l2);
    }
    return a2;
  };
  n2.wrap = function(r3) {
  ...
  n2.get = function(r3) {
    ...
    if (e3 = r3.match(/^#([a-f0-9]{6})([a-f0-9]{2})?$/i)) {
      ...
      if (!(e3 = r3.match(/^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/)))
        return (e3 = r3.match(/(\D+)/)) ? "transparent" === e3[1] ? [0, 0, 0, 0] : (o3 = N[e3[1]]) ? (o3[3] = 1, o3) : null : null;
      for (t3 = 0; t3 < 3; t3++)
    ...
    var r3 = C(arguments);
    return r3.length < 4 || 1 === r3[3] ? "rgb(" + Math.round(r3[0]) + ", " + Math.round(r3[1]) + ", " + Math.round(r3[2]) + ")" : "rgba(" + Math.round(r3[0]) + ", " + Math.round(r3[1]) + ", " + Math.round(r3[2]) + ", " + r3[3] + ")";
    ...
    return r3.length < 4 || 1 === r3[3] ? "rgb(" + e3 + "%, " + t3 + "%, " + n3 + "%)" : "rgba(" + e3 + "%, " + t3 + "%, " + n3 + "%, " + r3[3] + ")";
  }, n2.to.hsl = function() {
    var r3 = C(arguments);
    return r3.length < 4 || 1 === r3[3] ? "hsl(" + r3[0] + ", " + r3[1] + "%, " + r3[2] + "%)" : "hsla(" + r3[0] + ", " + r3[1] + "%, " + r3[2] + "%, " + r3[3] + ")";
  }, n2.to.hwb = function() {
    var r3 = C(arguments), e3 = "";
    return r3.length >= 4 && 1 !== r3[3] && (e3 = ", " + r3[3]), "hwb(" + r3[0] + ", " + r3[1] + "%, " + r3[2] + "%" + e3 + ")";
...
var T = e(function(r2) {
  ...
  n2.rgb.hsl = function(r3) {
    ...
    return 0 === u2 ? a3 = o3 = 0 : (o3 = u2 / h2, e3 = c2(i3), t3 = c2(l2), n3 = c2(s2), i3 === h2 ? a3 = n3 - t3 : l2 === h2 ? a3 = 1 / 3 + e3 - n3 : s2 === h2 && (a3 = 2 / 3 + t3 - e3), a3 < 0 ? a3 += 1 : a3 > 1 && (a3 -= 1)), [360 * a3, 100 * o3, 100 * h2];
    ...
    return t3 *= (n3 *= 2) <= 1 ? n3 : 2 - n3, a3 *= o3 <= 1 ? o3 : 2 - o3, [e3, 100 * (0 === n3 ? 2 * a3 / (o3 + a3) : 2 * t3 / (n3 + t3)), 100 * ((n3 + t3) / 2)];
    ...
    switch (c2 > 1 && (h2 /= c2, u2 /= c2), n3 = 6 * s2 - (e3 = Math.floor(6 * s2)), 0 != (1 & e3) && (n3 = 1 - n3), a3 = h2 + n3 * ((t3 = 1 - u2) - h2), e3) {
      default:
      case 6:
      case 0:
        o3 = t3, i3 = a3, l2 = h2;
    ...
    if (!e3)
      return [0, 0, 0];
    var t3 = e3[0];
    3 === e3[0].length && (t3 = t3.split("").map(function(r4) {
      return r4 + r4;
    }).join(""));
...
function J(r2) {
  ...
  for (e2[r2].distance = 0; t2.length; )
    for (var n2 = t2.pop(), a2 = Object.keys(T[n2]), o2 = a2.length, i2 = 0; i2 < o2; i2++) {
      ...
      -1 === s2.distance && (s2.distance = e2[n2].distance + 1, s2.parent = n2, t2.unshift(l2));
    }
  return e2;
}
function R(r2, e2) {
...
Object.keys(T).forEach(function(r2) {
  ...
  var e2 = function(r3) {
    for (var e3 = J(r3), t2 = {}, n2 = Object.keys(e3), a2 = n2.length, o2 = 0; o2 < a2; o2++) {
      var i2 = n2[o2];
      null !== e3[i2].parent && (t2[i2] = G(i2, e3));
    }
    return t2;
  }(r2);
  Object.keys(e2).forEach(function(t2) {
    ...
    B[r2][t2] = function(r3) {
      ...
      var e3 = function(e4) {
        return null == e4 ? e4 : (arguments.length > 1 && (e4 = Array.prototype.slice.call(arguments)), r3(e4));
      };
      return "conversion" in r3 && (e3.conversion = r3.conversion), e3;
    }(n2);
  });
...
function X(r2, e2) {
  ...
  if (null == r2)
    ...
    this.model = a2.model, n2 = H[this.model].channels, this.color = a2.value.slice(0, n2), this.valpha = "number" == typeof a2.value[n2] ? a2.value[n2] : 1;
  } else if (r2.length) {
    this.model = e2 || "rgb", n2 = H[this.model].channels;
    var o2 = K.call(r2, 0, n2);
    this.color = er(o2, n2), this.valpha = "number" == typeof r2[n2] ? r2[n2] : 1;
    ...
    "alpha" in r2 && (i2.splice(i2.indexOf("alpha"), 1), this.valpha = "number" == typeof r2.alpha ? r2.alpha : 0);
    var l2 = i2.sort().join("");
    if (!(l2 in V))
...
X.prototype = { toString: function() {
  ...
  var e2 = this.model in U.to ? this : this.rgb(), t2 = 1 === (e2 = e2.round("number" == typeof r2 ? r2 : 1)).valpha ? e2.color : e2.color.concat(this.valpha);
  return U.to[e2.model](t2);
}, percentString: function(r2) {
  var e2 = this.rgb().round("number" == typeof r2 ? r2 : 1), t2 = 1 === e2.valpha ? e2.color : e2.color.concat(this.valpha);
  ...
  return 1 !== this.valpha && (r2.alpha = this.valpha), r2;
}, unitArray: function() {
  var r2 = this.rgb().color;
  return r2[0] /= 255, r2[1] /= 255, r2[2] /= 255, 1 !== this.valpha && r2.push(this.valpha), r2;
}, unitObject: function() {
  var r2 = this.rgb().object();
  return r2.r /= 255, r2.g /= 255, r2.b /= 255, 1 !== this.valpha && (r2.alpha = this.valpha), r2;
}, round: function(r2) {
  ...
  var t2 = r2.rgb(), n2 = this.rgb(), a2 = void 0 === e2 ? 0.5 : e2, o2 = 2 * a2 - 1, i2 = t2.alpha() - n2.alpha(), l2 = ((o2 * i2 == -1 ? o2 : (o2 + i2) / (1 + o2 * i2)) + 1) / 2, s2 = 1 - l2;
  ...
  if (-1 === Q.indexOf(r2)) {
    ...
    X.prototype[r2] = function() {
      ...
      var t2 = "number" == typeof arguments[e2] ? e2 : this.valpha;
      return new X(rr(H[this.model][r2].raw(this.color)).concat(t2), r2);
    }, X[r2] = function(t2) {
      return "number" == typeof t2 && (t2 = er(K.call(arguments), e2)), new X(t2, r2);
    };
  }
});
var tr = X;
function index_es_default(r2, e2) {
  ...
  if (Array.isArray(r2)) {
    var s2 = r2;
    l2.uniq && (s2 = L(r2)), void 0 !== s2 && (t2 = s2.map(function(r3) {
      return tr(r3);
    }));
  } else {
    if ("object" != typeof r2)
  ...
  return t2.map(function(r3) {
    ...
    return e3.hex = r3.hex(), e3.combinations = t2.filter(function(e4) {
      ...
      return void 0 === l2.threshold || r3.contrast(e4) > l2.threshold;
    }).map(function(e4) {
