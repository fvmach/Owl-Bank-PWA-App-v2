...
@color-background-inverse-stronger-elevation: rgb(103, 114, 142);
...
@color-background-inverse-strong: rgb(64, 79, 110);
...
@color-background-inverse-stronger: rgb(96, 107, 133);
/* Weakest background color with no semantic meaning, used for decorative purposes only. Should generally be used with matching decorative border and/or text tokens. */
...
@color-background-stronger: rgb(202, 205, 216);
/* Elevation token for color-background-inverse-strong elements. */
@color-background-inverse-strong-elevation: rgb(75, 86, 113);
...
@color-background-inverse-weak-elevation: rgb(25, 39, 62);
...
@shadow-border-top-primary: 0 -1px 0 #3366FF;
...
@shadow-elevation-20: 0 0 0 1px #f9f9fa, 0 6px 8px 0 rgba(15, 22, 33, 0.1), 16px 16px 32px 0 rgba(15, 22, 33, 0.05);
...
/* Primary text. */
@color-text-primary: rgb(51, 102, 255);
