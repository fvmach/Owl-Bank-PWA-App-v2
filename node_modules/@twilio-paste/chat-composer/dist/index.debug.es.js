...
var ChatComposer = React5.forwardRef(
  ({
    ...
    return /* @__PURE__ */ React5.createElement(
      ...
      /* @__PURE__ */ React5.createElement(StylingGlobals, { styles: chatComposerLexicalStyles }),
      /* @__PURE__ */ React5.createElement(LexicalComposer, { initialConfig: (0, import_deepmerge.default)(baseConfigWithEditorState, config) }, /* @__PURE__ */ React5.createElement(React5.Fragment, null, /* @__PURE__ */ React5.createElement(
        RichTextPlugin,
        {
          contentEditable: /* @__PURE__ */ React5.createElement(ContentEditable, { ...props, className: "paste-chat-composer-content-editable" }),
          placeholder: /* @__PURE__ */ React5.createElement(PlaceholderWrapper, { element: `${element}_PLACEHOLDER_WRAPPER`, placeholder }),
          ErrorBoundary
        }
      ), onChange && /* @__PURE__ */ React5.createElement(OnChangePlugin, { onChange }), /* @__PURE__ */ React5.createElement(HistoryPlugin, null), /* @__PURE__ */ React5.createElement(AutoLinkPlugin, null), /* @__PURE__ */ React5.createElement(ToggleEditablePlugin, { disabled }), editorInstanceRef && /* @__PURE__ */ React5.createElement(EditorRefPlugin, { editorRef: editorInstanceRef }), children))
    );
  }
);
...
import { Box as Box4, safelySpreadBoxProps as safelySpreadBoxProps2 } from "@twilio-paste/box";
...
import { Box as Box17, safelySpreadBoxProps as safelySpreadBoxProps14 } from "@twilio-paste/box";

// ../anchor/dist/index.es.js
import { Box as Box32, safelySpreadBoxProps as safelySpreadBoxProps4 } from "@twilio-paste/box";
...
var source = React9.createContext(createSource());
...
var useUIDState = function() {
  var context = useContext3(source), uid2 = useState3(function() {
...
var useId = "useId";
var maybeReactUseId = React42[useId];
...
// ../../../paste-icons/esm/LinkExternalIcon.js
import * as r from "react";

// ../../../paste-icons/esm/helpers/IconWrapper.js
import { Box as H, safelySpreadBoxProps as w } from "@twilio-paste/box";
...
var i = (o, e, r4) => e in o ? d(o, e, { enumerable: true, configurable: true, writable: true, value: r4 }) : o[e] = r4;
var n = (o, e) => {
  for (var r4 in e || (e = {}))
    a.call(e, r4) && i(o, r4, e[r4]);
  if (s)
    for (var r4 of s(e))
      l.call(e, r4) && i(o, r4, e[r4]);
  return o;
};
var m = (o, e) => B(o, z(e));
var c = (o, e) => {
...
// ../../../paste-icons/esm/ArrowForwardIcon.js
import * as r2 from "react";
var n2 = r2.forwardRef(({ as: a3, display: i2, element: p = "ICON", size: t, color: s2, title: o, decorative: e }, w2) => {
  const l2 = `ArrowForwardIcon-${useUID2()}`;
  if (!e && o == null)
    throw new Error("[ArrowForwardIcon]: Missing a title for non-decorative icon.");
  return r2.createElement(P, { as: a3, display: i2, element: p, size: t, color: s2, ref: w2 }, r2.createElement("svg", { role: "img", "aria-hidden": e, xmlns: "http://www.w3.org/2000/svg", width: "100%", height: "100%", viewBox: "0 0 20 20", "aria-labelledby": l2 }, o ? r2.createElement("title", { id: l2 }, o) : null, r2.createElement("path", { fill: "currentColor", fillRule: "evenodd", d: "M14.991 9.91l.007.05v.08l-.01.07-.01.029a.489.489 0 01-.205.272l-3.832 3.444a.596.596 0 01-.78 0 .459.459 0 01-.063-.632l.063-.069 2.957-2.659H5.513A.504.504 0 015 10a.5.5 0 01.42-.488l.093-.008h7.604l-2.956-2.658a.459.459 0 01-.063-.632l.063-.069a.598.598 0 01.704-.057l.076.057 3.832 3.444c.098.064.172.16.206.272l.012.049z" })));
});
n2.displayName = "ArrowForwardIcon";
...
`;
var StyledCircleTrack = styled.circle({ transformOrigin: "center", opacity: 0.25 });
var AnimatedStyledCircle = styled.circle(({ show, isSafari }) => ({ transformOrigin: "center", animation: isSafari ? "none" : `1.5s ease-in-out infinite both ${CircleKeyframes}`, strokeDasharray: circleCircumference, opacity: show ? 1 : 0 }));
var StyledSvg = styled.svg(({ isSafari }) => ({ height: "100%", width: "100%", display: "block", animation: isSafari ? `1s infinite linear ${SafariSvgKeyframes}` : `4.25s linear infinite both ${SvgKeyframes}` }));
var Spinner = React11.forwardRef(({ size, color = "currentColor", title, as, display: display2, decorative, delay = 250, element = "SPINNER" }, ref) => {
  let titleId = `spinner-${useUID2()}`, { borderWidths: { borderWidth40 } } = useTheme(), [show, setShow] = React11.useState(delay === 0);
...
import { Box as Box7, safelySpreadBoxProps as safelySpreadBoxProps5 } from "@twilio-paste/box";
import * as React12 from "react";
import { Box as Box23, safelySpreadBoxProps as safelySpreadBoxProps22 } from "@twilio-paste/box";
import * as React23 from "react";
import { Box as Box33, safelySpreadBoxProps as safelySpreadBoxProps32 } from "@twilio-paste/box";
import * as React34 from "react";
import { Box as Box42, safelySpreadBoxProps as safelySpreadBoxProps42 } from "@twilio-paste/box";
import * as React43 from "react";
import { Box as Box52, safelySpreadBoxProps as safelySpreadBoxProps52 } from "@twilio-paste/box";
import * as React52 from "react";
import { Box as Box62, safelySpreadBoxProps as safelySpreadBoxProps6 } from "@twilio-paste/box";
import * as React62 from "react";
import { Box as Box72, safelySpreadBoxProps as safelySpreadBoxProps7 } from "@twilio-paste/box";
...
import { Box as Box11, safelySpreadBoxProps as safelySpreadBoxProps10 } from "@twilio-paste/box";
import * as React112 from "react";
import { Box as Box12, safelySpreadBoxProps as safelySpreadBoxProps11 } from "@twilio-paste/box";
...
var require_cjs2 = __commonJS2({ "../../../../node_modules/deepmerge/dist/cjs.js"(exports, module) {
  "use strict";
...
var DestructiveButton = React12.forwardRef(({ size, buttonState, fullWidth, ...props }, ref) => React12.createElement(Box7, { ref, width: fullWidth ? "100%" : "auto", ...safelySpreadBoxProps5(props), ...ButtonStyleMapping[buttonState], ...SizeStyles[size] }));
...
var DestructiveIconButton = React23.forwardRef(({ size, buttonState, fullWidth, ...props }, ref) => React23.createElement(Box23, { ref, width: fullWidth ? "100%" : "auto", ...safelySpreadBoxProps22(props), ...ButtonStyleMapping2[buttonState], ...SizeStyles[size] }));
...
var DestructiveLinkButton = React34.forwardRef(({ size, buttonState, fullWidth, ...props }, ref) => React34.createElement(Box33, { ref, width: fullWidth ? "100%" : "auto", ...safelySpreadBoxProps32(props), ...ButtonStyleMapping3[buttonState], ...SizeStyles[size] }));
...
var DestructiveSecondaryButton = React43.forwardRef(({ size, buttonState, fullWidth, pressed, ...props }, ref) => {
  ...
  return React43.createElement(Box42, { ref, width: fullWidth ? "100%" : "auto", "aria-pressed": pressed, ...safelySpreadBoxProps42(props), ...ButtonStyleMapping4[buttonState], ...toggleStyles, ...SizeStyles[size] });
});
...
var InverseButton = React52.forwardRef(({ size, buttonState, fullWidth, ...props }, ref) => React52.createElement(Box52, { ref, width: fullWidth ? "100%" : "auto", ...safelySpreadBoxProps52(props), ...ButtonStyleMapping5[buttonState], ...SizeStyles[size] }));
...
var InverseLinkButton = React62.forwardRef(({ size, buttonState, fullWidth, ...props }, ref) => React62.createElement(Box62, { ref, width: fullWidth ? "100%" : "auto", ...safelySpreadBoxProps6(props), ...ButtonStyleMapping6[buttonState], ...SizeStyles[size] }));
...
var LinkButton = React72.forwardRef(({ size, buttonState, fullWidth, ...props }, ref) => React72.createElement(Box72, { ref, width: fullWidth ? "100%" : "auto", ...safelySpreadBoxProps7(props), ...ButtonStyleMapping7[buttonState], ...SizeStyles[size] }));
...
var PrimaryButton = React82.forwardRef(({ size, buttonState, fullWidth, ...props }, ref) => React82.createElement(Box8, { ref, width: fullWidth ? "100%" : "auto", ...safelySpreadBoxProps8(props), ...ButtonStyleMapping8[buttonState], ...SizeStyles[size] }));
...
var PrimaryIconButton = React92.forwardRef(({ size, buttonState, fullWidth, ...props }, ref) => React92.createElement(Box9, { ref, width: fullWidth ? "100%" : "auto", ...safelySpreadBoxProps9(props), ...ButtonStyleMapping9[buttonState], ...SizeStyles[size] }));
...
var ResetButton = React102.forwardRef(({ size, buttonState, fullWidth, ...props }, ref) => React102.createElement(Box10, { ref, width: fullWidth ? "100%" : "auto", ...ButtonStyleMapping10[buttonState], ...SizeStyles[size], ...props }));
...
var SecondaryButton = React112.forwardRef(({ size, buttonState, fullWidth, pressed, ...props }, ref) => {
  ...
  return React112.createElement(Box11, { ref, width: fullWidth ? "100%" : "auto", "aria-pressed": pressed, ...safelySpreadBoxProps10(props), ...ButtonStyleMapping11[buttonState], ...toggleStyles, ...SizeStyles[size] });
});
...
var SecondaryIconButton = React122.forwardRef(({ size, buttonState, fullWidth, pressed, ...props }, ref) => {
  ...
  return React122.createElement(Box12, { ref, "aria-pressed": pressed, width: fullWidth ? "100%" : "auto", ...safelySpreadBoxProps11(props), ...toggleStyles, ...ButtonStyleMapping12[buttonState], ...SizeStyles[size] });
});
...
var ButtonContents = ({ buttonState, children, showLoading, variant }) => {
  ...
  return React13.createElement(React13.Fragment, null, React13.createElement(Box13, { as: "span", display: "flex", textDecoration: "inherit", opacity: buttonState === "loading" ? "0" : "1", justifyContent: buttonVariantHasBoundingBox ? null : "center", columnGap: "space20", alignItems: "center", width: "100%" }, children), showLoading ? React13.createElement(Box13, { as: "span", position: "absolute", top: 0, right: 0, bottom: 0, left: 0, display: "flex", justifyContent: "center", alignItems: "center", lineHeight: "lineHeight30" }, React13.createElement(Spinner, { decorative: true, delay: 0 })) : null);
};
...
var Button = React13.forwardRef(({ element = "BUTTON", i18nExternalLinkLabel = "(link takes you to an external page)", ...props }, ref) => {
  ...
  return props.as === "a" && props.href != null && typeof children == "string" && variant !== "reset" && (injectIconChildren = React13.createElement(React13.Fragment, null, children, externalLinkProps != null ? React13.createElement(a2, { decorative: false, title: i18nExternalLinkLabel }) : React13.createElement(AnimatedBox, { style: arrowIconStyles }, React13.createElement(n2, { decorative: true })))), React13.createElement(ButtonComponent, { ...externalLinkProps, ...rest, onMouseEnter: (event) => {
...
import { Box as Box24, safelySpreadBoxProps as safelySpreadBoxProps23 } from "@twilio-paste/box";
import * as React24 from "react";
import { Box as Box34, safelySpreadBoxProps as safelySpreadBoxProps33 } from "@twilio-paste/box";
import * as React35 from "react";
var MediaObject = React14.forwardRef(({ as = "span", children, element = "MEDIA_OBJECT", marginBottom, marginTop, verticalAlign: verticalAlign2 = "top", ...props }, ref) => React14.createElement(Box14, { ...safelySpreadBoxProps12(props), alignItems: verticalAlign2 === "top" ? "flex-start" : "center", as, display: "flex", element, marginBottom, marginTop, ref }, children));
MediaObject.displayName = "MediaObject";
var MediaFigure = React24.forwardRef(({ align = "start", as = "span", children, element = "MEDIA_FIGURE", spacing = "space0", ...props }, ref) => React24.createElement(Box24, { ...safelySpreadBoxProps23(props), as, display: "flex", element, flexShrink: 0, marginLeft: align === "end" ? spacing : void 0, marginRight: align === "start" ? spacing : void 0, ref }, children));
MediaFigure.displayName = "MediaFigure";
var MediaBody = React35.forwardRef(({ as = "span", children, element = "MEDIA_BODY", ...props }, ref) => React35.createElement(Box34, { ...safelySpreadBoxProps33(props), as, element, flex: 1, minWidth: "size0", ref }, children));
MediaBody.displayName = "MediaBody";

// ../screen-reader-only/dist/index.es.js
import { Box as Box15 } from "@twilio-paste/box";
import * as React15 from "react";
var ScreenReaderOnly = React15.forwardRef(({ as = "span", children, ...props }, ref) => React15.createElement(Box15, { ...props, as, border: "none", clip: "rect(0 0 0 0)", height: "1px", margin: "spaceNegative10", overflow: "hidden", padding: "space0", position: "absolute", ref, textTransform: "none", whiteSpace: "nowrap", width: "1px" }, children));
ScreenReaderOnly.displayName = "ScreenReaderOnly";

// ../../layout/stack/dist/index.es.js
import { Box as Box16, safelySpreadBoxProps as safelySpreadBoxProps13 } from "@twilio-paste/box";
...
var getStackChildMargins = (orientation, spacing) => {
  ...
  if (Array.isArray(orientation)) {
    ...
    orientation.forEach((value, i2) => {
      marginRight[i2] = value === "horizontal" ? spacing : "space0", marginBottom[i2] = value === "horizontal" ? "space0" : spacing;
...
var Stack = React16.forwardRef(({ children, orientation, spacing, element = "STACK", ...props }, ref) => {
  ...
  return React16.createElement(Box16, { element, ...safelySpreadBoxProps13(props), ...stackStyles, ref }, validChildren.map((child, index) => React16.createElement(Box16, { element: `${element}_CHILD`, ...childrenCount !== index + 1 ? childMargins : null, key: keySeed(`stack-${index}`) }, child)));
});
    ...
    return /* @__PURE__ */ React17.createElement(
      ...
      onDismiss && /* @__PURE__ */ React17.createElement(
        ...
        /* @__PURE__ */ React17.createElement(
          ...
          /* @__PURE__ */ React17.createElement(n3, { decorative: true }),
...
import { boxShadow, compose, createShouldForwardProp, display, overflow, position, props as stylingProps, space, styled as styled2, typography, verticalAlign } from "@twilio-paste/styling-library";
...
var require_cjs3 = __commonJS3({ "../../../../node_modules/deepmerge/dist/cjs.js"(exports, module) {
  "use strict";
  var isMergeableObject = function(value) {
    return isNonNullObject(value) && !isSpecial(value);
  };
...
var getCustomElementStyles = (props) => {
  if (props != null && props.theme != null && props.theme.elements != null) {
    ...
    if (themeElements[targetElement] != null) {
      let elementOverrides = themeElements[targetElement], computedStyles = css(elementOverrides)(props), { variants, ...elementStyles } = computedStyles, variantStyles = {};
...
var shouldForwardProp = createShouldForwardProp([...stylingProps, ...Object.keys({ ...customStyleProps, ...PseudoPropStyles })]);
var StyledText = styled2("div", { shouldForwardProp })({ margin: 0, padding: 0 }, compose(boxShadow, display, overflow, position, space, typography, verticalAlign, PasteStyleProps), getPseudoStyles, getCustomElementStyles);
...
import { Box as Box18 } from "@twilio-paste/box";
import * as React20 from "react";
var Truncate = React20.forwardRef(({ children, ...props }, ref) => React20.createElement(Box18, { ...props, as: "span", display: "inline-block", verticalAlign: "bottom", textDecoration: "inherit", maxWidth: "100%", overflow: "hidden", ref, textOverflow: "ellipsis", whiteSpace: "nowrap" }, children));
