...
var ThemeConsumer = ({ children, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(import_styling_library.ThemeContext.Consumer, null, (theme) => {
...
var pasteGlobalStyles = (0, import_styling_library4.css)({
  html: {
...
var useThemeOverwriteHook = () => {
  const [overwriteTheme, setOverwriteTheme] = React2.useState(getThemeFromHash());
...
var ThemeProvider = ({
  ...
  const [cache] = React2.useState(cacheProviderProps ? (0, import_styling_library5.createCache)(cacheProviderProps) : null);
