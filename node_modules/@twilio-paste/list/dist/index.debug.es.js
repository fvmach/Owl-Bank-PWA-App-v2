...
var StyledOrderedList = styled(Box)(({ variant }) => {
  return css({
...
var StyledOrderedListItem = styled2(Box2)(({ variant }) => {
...
var OrderedDisplayListItem = React6.forwardRef(
  ({ children, element = "ORDERED_DISPLAY_LIST_ITEM", ...props }, ref) => {
    ...
    return /* @__PURE__ */ React6.createElement(StyledOrderedListItem, { ...safelySpreadBoxProps(props), as: "li", element, variant, ref }, /* @__PURE__ */ React6.createElement("div", null, children));
  }
);
...
var OrderedDisplayListHeading = React7.forwardRef(
  ({ children, element = "ORDERED_DISPLAY_LIST_HEADING", as = "div", ...props }, ref) => {
    ...
    return /* @__PURE__ */ React7.createElement(Heading, { ...props, ref, as, variant, element, marginBottom: "space0" }, children);
  }
);
OrderedDisplayListHeading.displayName = "OrderedDisplayListHeading";

// src/UnorderedList.tsx
import { safelySpreadTextProps as safelySpreadTextProps4 } from "@twilio-paste/text";
