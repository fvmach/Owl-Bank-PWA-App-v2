...
var DestructiveButton = React.forwardRef(
...
var DestructiveIconButton = React2.forwardRef(
  ({ size, buttonState, fullWidth, ...props }, ref) => {
    return /* @__PURE__ */ React2.createElement(
      Box2,
      {
        ...
        ...ButtonStyleMapping2[buttonState],
        ...SizeStyles[size]
      }
    );
  }
...
var loadingStyles3 = (0, import_deepmerge4.default)(BaseStyles.loading, {
  color: "colorTextLinkDestructive",
  textAlign: "left",
...
var disabledStyles3 = (0, import_deepmerge4.default)(BaseStyles.disabled, {
  color: "colorTextWeaker",
  textAlign: "left",
...
var DestructiveLinkButton = React3.forwardRef(
  ({ size, buttonState, fullWidth, ...props }, ref) => {
    return /* @__PURE__ */ React3.createElement(
      Box3,
      {
        ...
        ...ButtonStyleMapping3[buttonState],
        ...SizeStyles[size]
      }
    );
  }
...
var DestructiveSecondaryButton = React4.forwardRef(
  ({ size, buttonState, fullWidth, pressed, ...props }, ref) => {
    const toggleStyles = pressed === void 0 ? {} : DestructiveSecondaryToggleStyles;
    return /* @__PURE__ */ React4.createElement(
      Box4,
      {
        ...
        ...ButtonStyleMapping4[buttonState],
        ...toggleStyles,
        ...SizeStyles[size]
      }
    );
...
var InverseButton = React5.forwardRef(
  ({ size, buttonState, fullWidth, ...props }, ref) => {
    return /* @__PURE__ */ React5.createElement(
      Box5,
      {
        ...
        ...ButtonStyleMapping5[buttonState],
        ...SizeStyles[size]
      }
    );
  }
...
var InverseLinkButton = React6.forwardRef(
  ({ size, buttonState, fullWidth, ...props }, ref) => {
    return /* @__PURE__ */ React6.createElement(
      Box6,
      {
        ...
        ...ButtonStyleMapping6[buttonState],
        ...SizeStyles[size]
      }
    );
  }
...
var LinkButton = React7.forwardRef(
  ({ size, buttonState, fullWidth, ...props }, ref) => {
    return /* @__PURE__ */ React7.createElement(
      Box7,
      {
        ...
        ...ButtonStyleMapping7[buttonState],
        ...SizeStyles[size]
      }
    );
  }
...
var loadingStyles8 = (0, import_deepmerge9.default)(BaseStyles.loading, {
  color: "colorTextPrimary",
  backgroundColor: "colorBackgroundBody",
  boxShadow: "shadowBorderWeak"
});
var disabledStyles8 = (0, import_deepmerge9.default)(BaseStyles.disabled, {
  color: "colorTextWeakest",
  backgroundColor: "colorBackgroundStrong",
  boxShadow: "shadowBorderWeaker"
});
  ...
  ({ size, buttonState, fullWidth, ...props }, ref) => {
    return /* @__PURE__ */ React8.createElement(
      Box8,
      {
        ...
        ...ButtonStyleMapping8[buttonState],
        ...SizeStyles[size]
      }
    );
  }
...
var PrimaryIconButton = React9.forwardRef(
  ({ size, buttonState, fullWidth, ...props }, ref) => {
    return /* @__PURE__ */ React9.createElement(
      Box9,
      {
        ...
        ...ButtonStyleMapping9[buttonState],
        ...SizeStyles[size]
      }
    );
  }
...
var ResetButton = React10.forwardRef(
  ({ size, buttonState, fullWidth, ...props }, ref) => {
    return /* @__PURE__ */ React10.createElement(
      Box10,
      {
        ref,
        width: fullWidth ? "100%" : "auto",
        ...ButtonStyleMapping10[buttonState],
        ...SizeStyles[size],
        ...props
      }
    );
...
var SecondaryButton = React11.forwardRef(
  ({ size, buttonState, fullWidth, pressed, ...props }, ref) => {
    ...
    return /* @__PURE__ */ React11.createElement(
      Box11,
      {
        ...
        ...ButtonStyleMapping11[buttonState],
        ...toggleStyles,
        ...SizeStyles[size]
      }
    );
...
var loadingStyles12 = (0, import_deepmerge13.default)(BaseStyles.loading, {
  color: "colorTextPrimary"
});
var disabledStyles12 = (0, import_deepmerge13.default)(BaseStyles.disabled, {
  color: "colorTextWeaker",
  _pressed: {
    backgroundColor: "colorBackgroundStrong",
    color: "colorTextWeak"
...
var SecondaryIconButton = React12.forwardRef(
  ({ size, buttonState, fullWidth, pressed, ...props }, ref) => {
    ...
    return /* @__PURE__ */ React12.createElement(
      Box12,
      {
        ...
        ...toggleStyles,
        ...ButtonStyleMapping12[buttonState],
        ...SizeStyles[size]
      }
    );
  }
