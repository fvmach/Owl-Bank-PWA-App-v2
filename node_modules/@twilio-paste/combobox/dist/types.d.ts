...
import type { UseComboboxPrimitiveProps, UseComboboxPrimitiveReturnValue, UseComboboxPrimitiveState, UseMultiSelectPrimitiveReturnValue, UseMultiSelectPrimitiveStateChange } from "@twilio-paste/combobox-primitive";
...
export interface MultiselectComboboxProps extends Omit<ComboboxProps, "autocomplete" | "initialSelectedItem" | "selectedItem" | "onSelectedItemChange" | "getA11yStatusMessage" | "getA11ySelectionMessage" | "state" | "hideVisibleLabel" | "element"> {
    /**
...
export interface ComboboxItemsProps extends Pick<ComboboxProps, "groupItemsBy" | "optionTemplate" | "groupLabelTemplate" | "element" | "emptyState" | "state"> {
    items: Item[];
    selectedItems?: Item[];
    disabledItems?: Item[];
    getItemProps: any;
