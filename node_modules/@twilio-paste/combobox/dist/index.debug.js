...
__export(src_exports, {
  ...
  useCombobox: () => import_combobox_primitive4.useComboboxPrimitive,
  useMultiselectCombobox: () => import_combobox_primitive4.useMultiSelectPrimitive
});
module.exports = __toCommonJS(src_exports);
var import_combobox_primitive4 = require("@twilio-paste/combobox-primitive");
...
var ComboboxListboxGroup = React2.forwardRef(
  ({ children, element = "COMBOBOX", groupName, groupLabelTemplate }, ref) => {
    return /* @__PURE__ */ React2.createElement(
      ...
      groupName ? /* @__PURE__ */ React2.createElement(
        import_box.Box,
        {
          as: "li",
...
var ComboboxListboxOption = React3.forwardRef(
  ({
    children,
    element = "COMBOBOX",
    highlighted,
    ...
    return /* @__PURE__ */ React3.createElement(
      ...
      {
        role: "option",
        ...(0, import_box2.safelySpreadBoxProps)(props2),
        ...
        color: highlighted ? "colorTextPrimary" : selected ? "colorTextPrimary" : "colorText",
        display: "flex",
      ...
      /* @__PURE__ */ React3.createElement(import_box2.Box, { as: "span" }, /* @__PURE__ */ React3.createElement(import_text2.Text, { as: "span", color: "inherit", element: `${element}_LIST_ITEM_TEXT` }, children)),
      /* @__PURE__ */ React3.createElement(import_box2.Box, { as: "span", hidden: !selected }, /* @__PURE__ */ React3.createElement(import_SelectedIcon.SelectedIcon, { decorative: true, color: "inherit" }))
    );
  }
);
...
var ComboboxItems = React4.memo(
  React4.forwardRef(
    ({
      ...
      const templatizedItems = React4.useMemo(() => {
      ...
      if (groupItemsBy == null) {
        if (virtualItems.length === 0 && EmptyState != null) {
          return /* @__PURE__ */ React4.createElement(ComboboxListboxGroup, { element, ref }, /* @__PURE__ */ React4.createElement(
            import_box3.Box,
            {
              as: "li",
              role: "option",
            ...
            /* @__PURE__ */ React4.createElement(EmptyState, null)
          ));
        }
        return /* @__PURE__ */ React4.createElement(ComboboxListboxGroup, { element, ref }, /* @__PURE__ */ React4.createElement("li", { role: "presentation", key: "total-size", style: { margin: 0, height: totalSize } }), virtualItems.map(({ measureRef, index: virtualItemIndex, start }) => {
      ...
      const groupedItems = React4.useMemo(() => {
      ...
      return /* @__PURE__ */ React4.createElement(React4.Fragment, null, groupedItemKeys.map((groupedItemKey) => {
        ...
        return /* @__PURE__ */ React4.createElement(
          ...
          groupedItems[groupedItemKey].map(({ index, ...item }) => {
...
// ../../../../node_modules/@radix-ui/react-use-rect/node_modules/@radix-ui/rect/dist/index.module.js
function $0f3bbd680c63c15c$export$5a50ff2cde8c3802(elementToObserve, callback) {
  const observedData1 = $0f3bbd680c63c15c$var$observedElements.get(elementToObserve);
  if (observedData1 === void 0) {
    ...
    if ($0f3bbd680c63c15c$var$observedElements.size === 1)
  ...
  return () => {
    ...
    if (observedData.callbacks.length === 0) {
      ...
      if ($0f3bbd680c63c15c$var$observedElements.size === 0)
        cancelAnimationFrame($0f3bbd680c63c15c$var$rafId);
    }
  };
}
var $0f3bbd680c63c15c$var$rafId;
var $0f3bbd680c63c15c$var$observedElements = /* @__PURE__ */ new Map();
function $0f3bbd680c63c15c$var$runLoop() {
  ...
  changedRectsData.forEach((data) => {
    data.callbacks.forEach(
      (callback) => callback(data.rect)
    );
  });
  $0f3bbd680c63c15c$var$rafId = requestAnimationFrame($0f3bbd680c63c15c$var$runLoop);
}
...
function $ccac1052a272b78b$export$9823a655542017cd(measurable) {
  ...
  (0, import_react2.useEffect)(() => {
    if (measurable) {
      const unobserve = $0f3bbd680c63c15c$export$5a50ff2cde8c3802(measurable, setRect);
      return () => {
        setRect(void 0);
        unobserve();
      };
...
// src/ListboxPositioner.tsx
var import_box4 = require("@twilio-paste/box");
var import_utils = require("@twilio-paste/utils");
var React5 = __toESM(require("react"));
var ListBoxPositioner = ({ inputBoxRef, dropdownBoxRef, ...props2 }) => {
  const { height: windowHeight } = (0, import_utils.useWindowSize)();
  const inputBoxDimensions = $ccac1052a272b78b$export$9823a655542017cd(inputBoxRef.current);
  const dropdownBoxDimensions = $ccac1052a272b78b$export$9823a655542017cd(dropdownBoxRef.current);
  const dropdownBoxHeight = dropdownBoxDimensions?.height;
  const styles = React5.useMemo(() => {
    ...
    if (windowHeight) {
      ...
      if (dropdownBoxHeight + inputBoxDimensions?.bottom >= windowHeight && inputBoxDimensions?.top - dropdownBoxHeight > 0) {
        return {
          position: "fixed",
  ...
  return /* @__PURE__ */ React5.createElement(import_box4.Box, { ...props2, ...styles, zIndex: "zIndex90" });
};
ListBoxPositioner.displayName = "ListBoxPositioner";

// src/ListboxWrapper.tsx
var ListboxWrapper = ({ inputBoxRef, parentRef, usePortal, children }) => {
  if (!usePortal)
    return /* @__PURE__ */ React6.createElement(import_box5.Box, { position: "absolute", top: "100%", width: "100%" }, children);
  return /* @__PURE__ */ React6.createElement(import_reakit_library.Portal, null, /* @__PURE__ */ React6.createElement(ListBoxPositioner, { inputBoxRef, dropdownBoxRef: parentRef }, children));
};
...
var ComboboxInputSelect = React7.forwardRef(({ ...props2 }, ref) => {
  return /* @__PURE__ */ React7.createElement(
    import_input.InputElement,
    {
...
var ComboboxInputWrapper = React8.forwardRef(
  ({ children, ...props2 }, ref) => {
    return /* @__PURE__ */ React8.createElement(import_box6.Box, { ...(0, import_box6.safelySpreadBoxProps)(props2), ref, display: "flex", position: "relative", width: "100%" }, children);
  }
);
...
var ComboboxListbox = React9.forwardRef(
  ({ children, element = "COMBOBOX_LISTBOX", hidden, ...props2 }, ref) => {
    if (hidden) {
      return /* @__PURE__ */ React9.createElement(import_box7.Box, { ...(0, import_box7.safelySpreadBoxProps)(props2), appearance: "none", ref });
    }
    return /* @__PURE__ */ React9.createElement(
      import_box7.Box,
      {
        ...(0, import_box7.safelySpreadBoxProps)(props2),
        as: "div",
        backgroundColor: "colorBackgroundBody",
...
var getDefaultState = ({
  ...
  return (0, import_combobox_primitive.useComboboxPrimitive)({
    initialSelectedItem,
    items,
    stateReducer,
    onHighlightedIndexChange: React10.useCallback(
      (changes) => {
...
var Combobox = React11.forwardRef(
  ({
    ...
    const inputBoxRef = React11.useRef(null);
    const {
      getComboboxProps,
      getInputProps,
      getItemProps,
    ...
    const scrollToIndexRef = React11.useCallback(
      (node) => {
        if (node) {
    ...
    return /* @__PURE__ */ React11.createElement(import_box8.Box, { position: "relative", element: `${element}_WRAPPER` }, /* @__PURE__ */ React11.createElement(import_box8.Box, { ...hideVisibleLabel && { ...visuallyHiddenStyles } }, /* @__PURE__ */ React11.createElement(import_label.Label, { disabled, required, variant, ...getLabelProps() }, labelText)), /* @__PURE__ */ React11.createElement(
      ...
      /* @__PURE__ */ React11.createElement(ComboboxInputWrapper, { ...getComboboxProps({ role: "combobox" }) }, /* @__PURE__ */ React11.createElement(
        ComboboxInputSelect,
        {
          ...getToggleButtonProps({ tabIndex: 0 }),
          ...getInputProps({ disabled, required, ref, ...props2 }),
          ...!autocomplete ? { onChange: (event) => event.preventDefault() } : void 0,
          autocomplete,
          "aria-describedby": helpText != null ? helpTextId : null,
          element: `${element}_ELEMENT`,
          textOverflow: "ellipsis"
        }
      ), !autocomplete && /* @__PURE__ */ React11.createElement(import_input_box.InputChevronWrapper, { element: `${element}_CHEVRON_WRAPPER` }, /* @__PURE__ */ React11.createElement(
    ...
    ), /* @__PURE__ */ React11.createElement(ListboxWrapper, { inputBoxRef, parentRef, usePortal }, /* @__PURE__ */ React11.createElement(ComboboxListbox, { hidden: !isOpen, element: `${element}_LISTBOX`, ...getMenuProps({ ref: parentRef }) }, /* @__PURE__ */ React11.createElement(
      ComboboxItems,
      {
    ...
    ))), helpText && /* @__PURE__ */ React11.createElement(import_help_text.HelpText, { id: helpTextId, variant: getHelpTextVariant2(variant, hasError) }, helpText));
  }
);
...
var import_utils3 = require("@twilio-paste/utils");
...
var GrowingInput = React12.forwardRef(
  ({ element = "GROWING_INPUT", onChange, initialValue = "", value, placeholder = "", ...props2 }, ref) => {
    const [text, setText] = React12.useState(value || initialValue);
    React12.useEffect(() => {
      setText(value || "");
    }, [value]);
...
// src/multiselect/extractPropsFromState.tsx
var import_combobox_primitive2 = require("@twilio-paste/combobox-primitive");
var import_isEmpty2 = __toESM(require_isEmpty());
var extractPropsFromState2 = ({
  state,
  initialSelectedItems,
  onSelectedItemsChange
}) => {
  if (state != null && !(0, import_isEmpty2.default)(state)) {
    return state;
  }
  return (0, import_combobox_primitive2.useMultiSelectPrimitive)({
    initialSelectedItems,
    onSelectedItemsChange
  });
};
...
// src/multiselect/MultiselectCombobox.tsx
var MultiselectCombobox = React13.forwardRef(
  ({
    usePortal = true,
    ...
    const parentRef = React13.useRef(null);
    const { width } = (0, import_utils3.useWindowSize)();
    const inputBoxRef = React13.useRef(null);
    const onSelectedItemsChange = React13.useCallback(
      (changes) => {
    ...
    const {
      ...
      getItemProps,
      highlightedIndex
    } = (0, import_combobox_primitive3.useComboboxPrimitive)({
      items,
      itemToString,
      selectedItem: null,
      ...
      stateReducer(_state, actionAndChanges) {
        ...
        switch (type) {
          case import_combobox_primitive3.useComboboxPrimitive.stateChangeTypes.InputKeyDownEnter:
          case import_combobox_primitive3.useComboboxPrimitive.stateChangeTypes.ItemClick:
          case import_combobox_primitive3.useComboboxPrimitive.stateChangeTypes.InputBlur:
            return {
              ...changes,
          ...
          case import_combobox_primitive3.useComboboxPrimitive.stateChangeTypes.MenuMouseLeave:
            return {
              ...changes,
              highlightedIndex: -2
            };
          case import_combobox_primitive3.useComboboxPrimitive.stateChangeTypes.ControlledPropUpdatedSelectedItem:
    ...
    const size = React13.useMemo(() => items.length, [items]);
    const rowVirtualizer = useVirtual({
      size,
      parentRef,
      overscan: 8
    ...
    const scrollToIndexRef = React13.useCallback(
      (node) => {
        if (node == null) {
          return;
        }
    ...
    return /* @__PURE__ */ React13.createElement(import_box10.Box, { position: "relative", element: `${element}_WRAPPER` }, /* @__PURE__ */ React13.createElement(import_label2.Label, { disabled, required, variant, ...getLabelProps() }, labelText), /* @__PURE__ */ React13.createElement(
      import_input_box2.InputBox,
      {
        disabled,
        hasError,
        element,
      ...
      /* @__PURE__ */ React13.createElement(
        ...
        /* @__PURE__ */ React13.createElement(
          import_form_pill_group.FormPillGroup,
          {
            ...pillState,
          ...
          selectedItems.map(function renderSelectedItems(selectedItemPill) {
            ...
            return /* @__PURE__ */ React13.createElement(
              import_form_pill_group.FormPill,
              {
        ...
        /* @__PURE__ */ React13.createElement(import_input_box2.InputChevronWrapper, { element: `${element}_CHEVRON_WRAPPER` }, /* @__PURE__ */ React13.createElement(import_ChevronDownIcon2.ChevronDownIcon, { decorative: true, color: (0, import_input_box2.getInputChevronIconColor)("default", false, false), size: "sizeIcon30" }))
      )
    ), /* @__PURE__ */ React13.createElement(ListboxWrapper, { inputBoxRef, parentRef, usePortal }, /* @__PURE__ */ React13.createElement(
      ComboboxListbox,
      {
    ...
    )), helpText && /* @__PURE__ */ React13.createElement(import_help_text2.HelpText, { id: helpTextId, variant: getHelpTextVariant(variant, hasError), element: `${element}_HELP_TEXT` }, helpText), /* @__PURE__ */ React13.createElement(import_screen_reader_only.ScreenReaderOnly, { id: a11yLabelId }, i18nKeyboardControls));
  }
);
