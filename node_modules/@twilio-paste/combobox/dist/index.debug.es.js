...
// src/index.tsx
import {
  useComboboxPrimitive as useComboboxPrimitive3,
  useMultiSelectPrimitive as useMultiSelectPrimitive2
...
var ComboboxListboxOption = React3.forwardRef(
  ({
    ...
    return /* @__PURE__ */ React3.createElement(
      ...
      /* @__PURE__ */ React3.createElement(Box2, { as: "span" }, /* @__PURE__ */ React3.createElement(Text2, { as: "span", color: "inherit", element: `${element}_LIST_ITEM_TEXT` }, children)),
      /* @__PURE__ */ React3.createElement(Box2, { as: "span", hidden: !selected }, /* @__PURE__ */ React3.createElement(SelectedIcon, { decorative: true, color: "inherit" }))
    );
  }
);
...
var ListBoxPositioner = ({ inputBoxRef, dropdownBoxRef, ...props2 }) => {
  ...
  return /* @__PURE__ */ React5.createElement(Box4, { ...props2, ...styles, zIndex: "zIndex90" });
};
...
var ListboxWrapper = ({ inputBoxRef, parentRef, usePortal, children }) => {
  if (!usePortal)
    return /* @__PURE__ */ React6.createElement(Box5, { position: "absolute", top: "100%", width: "100%" }, children);
  return /* @__PURE__ */ React6.createElement(Portal, null, /* @__PURE__ */ React6.createElement(ListBoxPositioner, { inputBoxRef, dropdownBoxRef: parentRef }, children));
};
...
import { Box as Box6, safelySpreadBoxProps as safelySpreadBoxProps2 } from "@twilio-paste/box";
import * as React8 from "react";
var ComboboxInputWrapper = React8.forwardRef(
  ({ children, ...props2 }, ref) => {
    return /* @__PURE__ */ React8.createElement(Box6, { ...safelySpreadBoxProps2(props2), ref, display: "flex", position: "relative", width: "100%" }, children);
  }
);
ComboboxInputWrapper.displayName = "ComboboxInputWrapper";

// src/styles/ComboboxListbox.tsx
import { Box as Box7, safelySpreadBoxProps as safelySpreadBoxProps3 } from "@twilio-paste/box";
import * as React9 from "react";
var ComboboxListbox = React9.forwardRef(
  ({ children, element = "COMBOBOX_LISTBOX", hidden, ...props2 }, ref) => {
    if (hidden) {
      return /* @__PURE__ */ React9.createElement(Box7, { ...safelySpreadBoxProps3(props2), appearance: "none", ref });
    }
...
var Combobox = React11.forwardRef(
  ({
    ...
    return /* @__PURE__ */ React11.createElement(Box8, { position: "relative", element: `${element}_WRAPPER` }, /* @__PURE__ */ React11.createElement(Box8, { ...hideVisibleLabel && { ...visuallyHiddenStyles } }, /* @__PURE__ */ React11.createElement(Label, { disabled, required, variant, ...getLabelProps() }, labelText)), /* @__PURE__ */ React11.createElement(
      InputBox,
      {
        disabled,
        element,
      ...
      ), !autocomplete && /* @__PURE__ */ React11.createElement(InputChevronWrapper, { element: `${element}_CHEVRON_WRAPPER` }, /* @__PURE__ */ React11.createElement(
        ChevronDownIcon,
        {
          decorative: true,
    ...
    ))), helpText && /* @__PURE__ */ React11.createElement(HelpText, { id: helpTextId, variant: getHelpTextVariant2(variant, hasError) }, helpText));
  }
);
...
var extractPropsFromState2 = ({
  ...
  return useMultiSelectPrimitive({
    initialSelectedItems,
    onSelectedItemsChange
  });
};
...
var MultiselectCombobox = React13.forwardRef(
  ({
    ...
    const {
      ...
      stateReducer(_state, actionAndChanges) {
        ...
        switch (type) {
          ...
          case useComboboxPrimitive2.stateChangeTypes.ControlledPropUpdatedSelectedItem:
    ...
    return /* @__PURE__ */ React13.createElement(Box10, { position: "relative", element: `${element}_WRAPPER` }, /* @__PURE__ */ React13.createElement(Label2, { disabled, required, variant, ...getLabelProps() }, labelText), /* @__PURE__ */ React13.createElement(
      InputBox2,
      {
        disabled,
        hasError,
      ...
      /* @__PURE__ */ React13.createElement(
        ...
        /* @__PURE__ */ React13.createElement(InputChevronWrapper2, { element: `${element}_CHEVRON_WRAPPER` }, /* @__PURE__ */ React13.createElement(ChevronDownIcon2, { decorative: true, color: getInputChevronIconColor2("default", false, false), size: "sizeIcon30" }))
      )
    ...
    )), helpText && /* @__PURE__ */ React13.createElement(HelpText2, { id: helpTextId, variant: getHelpTextVariant(variant, hasError), element: `${element}_HELP_TEXT` }, helpText), /* @__PURE__ */ React13.createElement(ScreenReaderOnly, { id: a11yLabelId }, i18nKeyboardControls));
  }
);
...
export {
  ...
  useMultiSelectPrimitive2 as useMultiselectCombobox
};
