...
var Select = React3.forwardRef(
  ({
    ...
    return /* @__PURE__ */ React3.createElement(
      ...
      /* @__PURE__ */ React3.createElement(Box3, { display: "flex", width: "100%", position: "relative" }, showOptions ? /* @__PURE__ */ React3.createElement(
        SelectElement,
        {
        ...
        children
      ) : /* @__PURE__ */ React3.createElement(SelectElement, { key: "unmounted" }), !multiple && /* @__PURE__ */ React3.createElement(InputChevronWrapper, { element: `${element}_CHEVRON_WRAPPER` }, /* @__PURE__ */ React3.createElement(
        ChevronDownIcon,
        {
          "aria-hidden": "true",
          decorative: true,
