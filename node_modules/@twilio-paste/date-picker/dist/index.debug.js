...
var DatePicker = React.forwardRef(({ element = "DATEPICKER", ...props }, ref) => {
  return /* @__PURE__ */ React.createElement(import_input.Input, { element, max: "9999-12-31", ...props, type: "date", ref });
});
