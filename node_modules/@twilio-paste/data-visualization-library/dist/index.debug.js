...
__export(src_exports, {
  applyPasteHighchartsModules: () => applyPasteHighchartsModules,
...
// src/applyPasteHighchartsModules.tsx
var applyPasteHighchartsModules = (highcharts, accessibilityModule, ...rest) => {
  if (highcharts === void 0) {
    throw new Error("[applyPasteHighchartsModules]: Must provide highcharts into this function.");
  }
  if (accessibilityModule === void 0) {
    throw new Error(
  ...
  rest.forEach((module2) => module2(highcharts));
};
