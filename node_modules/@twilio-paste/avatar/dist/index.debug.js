...
var AvatarGroup = React.forwardRef(
  ({ variant, size, children, element = "AVATAR_GROUP" }, ref) => {
    return /* @__PURE__ */ React.createElement(AvatarGroupContext.Provider, { value: { variant, size } }, /* @__PURE__ */ React.createElement(import_stack.Stack, { orientation: "horizontal", spacing: getGroupSpacing(size, variant), element, ref }, children));
  }
);
...
var AvatarContents = ({
  ...
  if (src != null) {
    return /* @__PURE__ */ React2.createElement(import_box.Box, { as: "img", alt: name, maxWidth: "100%", boxShadow: "shadowBorderWeaker", src, size, title: name });
  }
  if (Icon != null) {
    ...
    return /* @__PURE__ */ React2.createElement(import_box.Box, { maxWidth: "100%", size, display: "flex", alignItems: "center", justifyContent: "center" }, /* @__PURE__ */ React2.createElement(Icon, { decorative: false, title: name, size: computedTokenNames.iconSize }));
  }
