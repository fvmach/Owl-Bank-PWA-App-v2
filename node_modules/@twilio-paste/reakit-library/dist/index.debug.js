...
function usePopoverState(initialState) {
  ...
  var _React$useState6 = (0, import_react28.useState)(false), mounted = _React$useState6[0], setMounted = _React$useState6[1];
...
function Portal(_ref) {
  ...
  var _React$useState = (0, import_react30.useState)(null), hostNode = _React$useState[0], setHostNode = _React$useState[1];
  ...
  if (hostNode) {
    return /* @__PURE__ */ (0, import_react_dom2.createPortal)(/* @__PURE__ */ (0, import_react30.createElement)(PortalContext.Provider, {
      value: hostNode
    }, children), hostNode);
  }
  return null;
