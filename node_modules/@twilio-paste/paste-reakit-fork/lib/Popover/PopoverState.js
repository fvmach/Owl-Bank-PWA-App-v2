...
function usePopoverState(initialState) {
  ...
  var _React$useState5 = React.useState({}),
      ...
      setArrowStyles = _React$useState5[1]; // [@twilio-paste]: Wait for portal mount
  ...
  var update = React.useCallback(function () {
    ...
    return false;
  }, []); // [@twilio-paste]: Use flushSync to address concurrent render issues in R18
  ...
  }, [originalPlacement, fixed, dialog.visible, flip, offset, preventOverflow, mounted]); // Ensure that the popover will be correctly positioned with an additional
  // update.
