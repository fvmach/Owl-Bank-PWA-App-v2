...
function useFocusTrap(dialogRef, visibleModals, options) {
  ...
  useEffect(function () {
    ...
    if (!portal) {
      process.env.NODE_ENV !== "production" ? warning(!!portalRef.current, "Can't trap focus within modal dialog because either `ref` wasn't passed to component.", "See https://reakit.io/docs/dialog") : void 0;
      return undefined;
    }
