...
var BaseRadioCheckboxLabel = React.forwardRef(
  ({ children, ...props }, ref) => {
    return /* @__PURE__ */ React.createElement(Label, { ...props, marginBottom: "space0", ref }, /* @__PURE__ */ React.createElement(Box, { as: "span", display: "flex" }, children));
  }
);
...
var BaseRadioCheckboxLabelText = React.forwardRef(
  ({ children, element = "BASE_RADIO_CHECKBOX_LABEL_TEXT", ...props }, ref) => {
    return /* @__PURE__ */ React.createElement(Text, { as: "span", color: "currentColor", marginLeft: "space20", element, ref, ...props }, children);
  }
);
...
var BaseRadioCheckboxHelpText = React.forwardRef(
  ({ children, helpTextId, element = "BASE_RADIO_CHECKBOX_HELP_TEXT_WRAPPER" }, ref) => {
    return /* @__PURE__ */ React.createElement(Box, { as: "span", display: "block", element, marginLeft: "space70", ref }, /* @__PURE__ */ React.createElement(HelpText, { id: helpTextId, marginTop: "space0" }, children));
  }
);
